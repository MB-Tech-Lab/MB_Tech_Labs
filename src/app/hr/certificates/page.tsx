...
export default function CertificatesPage() {
  return (
    <div>
      <h1 className="font-display text-xl font-semibold text-white">Certificates</h1>
      <p className="text-[12.5px] text-white/45 mt-0.5 mb-6">Manage Certificates from this module</p>
