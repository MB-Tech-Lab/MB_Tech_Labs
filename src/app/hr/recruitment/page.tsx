...
export default function RecruitmentPage() {
  return (
    <div>
      <h1 className="font-display text-xl font-semibold text-white">Recruitment</h1>
      <p className="text-[12.5px] text-white/45 mt-0.5 mb-6">Manage Recruitment from this module</p>
