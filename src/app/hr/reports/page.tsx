...
export default function ReportsPage() {
  return (
    <div>
      <h1 className="font-display text-xl font-semibold text-white">Reports</h1>
      <p className="text-[12.5px] text-white/45 mt-0.5 mb-6">Manage Reports from this module</p>
