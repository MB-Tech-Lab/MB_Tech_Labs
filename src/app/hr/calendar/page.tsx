...
export default function CalendarPage() {
  return (
    <div>
      <h1 className="font-display text-xl font-semibold text-white">Calendar</h1>
      <p className="text-[12.5px] text-white/45 mt-0.5 mb-6">Manage Calendar from this module</p>
