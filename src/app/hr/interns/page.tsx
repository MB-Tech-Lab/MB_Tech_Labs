...
export default function InternsPage() {
  return (
    <div>
      <h1 className="font-display text-xl font-semibold text-white">Interns</h1>
      <p className="text-[12.5px] text-white/45 mt-0.5 mb-6">Manage Interns from this module</p>
