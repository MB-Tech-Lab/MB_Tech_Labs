...
export default function TrainingPage() {
  return (
    <div>
      <h1 className="font-display text-xl font-semibold text-white">Training</h1>
      <p className="text-[12.5px] text-white/45 mt-0.5 mb-6">Manage Training from this module</p>
