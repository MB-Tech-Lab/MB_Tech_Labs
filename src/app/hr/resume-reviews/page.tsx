...
export default function ResumereviewsPage() {
  return (
    <div>
      <h1 className="font-display text-xl font-semibold text-white">Resume Reviews</h1>
      <p className="text-[12.5px] text-white/45 mt-0.5 mb-6">Manage Resume Reviews from this module</p>
